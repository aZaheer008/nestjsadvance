...
import { Rule, SchematicContext, Tree, apply, chain,strings, externalSchematic, move, url,template, mergeWith } from '@angular-devkit/schematics';
...
function updateModuleFile(
  ...
  const source = ts.createSourceFile(
    moduleFilePath,
    moduleFileContent,
    ts.ScriptTarget.Latest, // use the latest Typescipt version
    true
  );
